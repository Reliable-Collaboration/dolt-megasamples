...
Findings about DoltgreSQL 1.3.1 and DoltLite v0.50.9 that reproduce with the one-table probes
below, written up as issue drafts. **None has been filed**: reporting is the maintainer's call, and
