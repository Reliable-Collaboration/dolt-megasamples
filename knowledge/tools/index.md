...
* [DoltLite v0.50.9](doltlite-0-50-9.md) - The SQLite fork with a versioned storage engine that the SQLite pair measures, pinned at v0.50.9 by the checksums of its Debian packages and built here into an image from them, with what was verified by replaying sakila into it before the experiment ran.
