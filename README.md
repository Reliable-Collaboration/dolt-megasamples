...
Measured on the 21 sample databases of
[`sql-megasamples`](https://github.com/Reliable-Collaboration/sql-megasamples), 9,056,697 rows
across 248 tables, each pair loaded from its own engine's dump. Every number here is
...
not answerable by reasoning about it, so this measures it, on the 21 sample
databases of `sql-megasamples` -- 9,056,697 rows of real, varied, publicly-licensed data
across 248 tables, from teaching schemas of a few hundred rows to a star schema of
