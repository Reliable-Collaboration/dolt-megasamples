...
| `oracle_sh` | Oracle's star-schema data-warehouse sample | 9 | 1,063,396 | 143.3 MiB | 144.7 MiB | 193.5 MiB |
| `adventureworks` | Microsoft's flagship 68-table, 5-schema OLTP sample (bicycle manufacturer) | 69 | 759,240 | 49.2 MiB | 38.7 MiB | 175.7 MiB |
| `contoso` | SQLBI's synthetic Contoso retail star schema V2 | 8 | 753,467 | 39.3 MiB | 40.3 MiB | 105.7 MiB |
| `lahman` | Sean Lahman's historical MLB statistics 1871-2025, now published by SABR as 27 CSV tables (plus Access and SQL Server forms) under CC BY-SA 3.0 | 27 | 706,466 | 26.3 MiB | 27.2 MiB | 83.8 MiB |
| `chicago_crimes` | The City of Chicago's 8.6 M-row reported-crime extract plus the 434-row IUCR code lookup | 2 | 259,702 | 28.7 MiB | 29.8 MiB | 88.7 MiB |
| `dvdstore` | Dell/VMware's open-source OLTP benchmark schema (DVD e-commerce with reviews and memberships) | 9 | 174,716 | 11.9 MiB | 10.8 MiB | 17.2 MiB |
| `stackexchange_beer` | CC BY-SA XML dump of a Stack Exchange Q&A site (Posts, Users, Comments, Votes, Badges, Tags, PostLinks, PostHistory) converted to MySQL with FULLTEXT | 11 | 62,523 | 14.0 MiB | 7.6 MiB | 19.2 MiB |
| `enron` | About 517k real corporate emails from 150 Enron custodians, distributed by CMU as a maildir-style tree of RFC 822 files | 3 | 48,778 | 34.1 MiB | 9.2 MiB | 38.2 MiB |
| `nyc_taxi` | New York City yellow and green taxi trip records in Parquet, plus the 265-row taxi zone lookup | 2 | 48,591 | 3.0 MiB | 2.8 MiB | 11.1 MiB |
| `sakila` | Oracle's DVD-rental sample database for MySQL (Version 1.5), 16 tables / 7 views / 3 procedures / 3 functions / 6 triggers, 46,268 rows | 16 | 47,268 | 2.0 MiB | 1.9 MiB | 8.1 MiB |
| `chinook` | Luis Rocha's digital media store sample (v1.4.5, 2024-02-12) | 11 | 15,607 | 615.0 KiB | 615.3 KiB | 1.2 MiB |
| `oracle_oe` | The object-relational Order Entry schema | 9 | 11,518 | 4.3 MiB | 1.5 MiB | 4.8 MiB |
| `oracle_co` | Oracle's "modern" e-commerce sample (7 tables, 8,783 rows) with identity columns, a JSON check constraint on a BLOB | 7 | 8,783 | 456.3 KiB | 454.5 KiB | 1.0 MiB |
| `adventureworks_lt` | The lightweight 12-table AdventureWorks (SalesLT schema) | 12 | 4,277 | 1.0 MiB | 1.0 MiB | 2.6 MiB |
| `northwind` | Microsoft's classic 13-table trading-company sample (SQL Server 2000 era) shipped as a single 1 MB T-SQL script with all data inline | 13 | 3,308 | 518.5 KiB | 539.3 KiB | 856.6 KiB |
| `smallsets` | Three classic teaching datasets in one database — the Titanic passenger list, Fisher's Iris measurements and the Palmer Penguins | 4 | 2,147 | 164.3 KiB | 156.3 KiB | 214.7 KiB |
