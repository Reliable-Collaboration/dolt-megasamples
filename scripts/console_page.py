...
<div class="creds">
  <b>Two accounts</b>, the same as sql-megasamples, on host <code>127.0.0.1</code> port
  <code>3307</code>.<br>
...
<footer>
  ...
  side of the comparison lives in <code>sql-megasamples</code> and serves 3306 and 8080–8084;
