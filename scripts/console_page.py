...
CONNECT = [
    (f"Dolt {DOLT_VERSION}, pinned (MySQL protocol)", [
    ...
    (f"DoltgreSQL {DOLTGRES_VERSION}, pinned (PostgreSQL protocol)", [
    ...
    (f"DoltLite v{LITE_VERSION}, pinned (files)", [
...
A = open in Adminer, Aᴘ = in Adminer on DoltgreSQL, P = in phpMyAdmin. Every engine version is pinned and changes only when the maintainer asks: see Pinned versions in README.md. Generated by scripts/console_page.py.</footer>
"""
